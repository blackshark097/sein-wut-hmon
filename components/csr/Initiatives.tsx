          ...
          {INITIATIVES.map((initiative, index) => {
            ...
            return (
              <motion.article
                ...
                className="group relative overflow-hidden rounded-lg border border-border/60 bg-bg-elev transition duration-500 hover:shadow-[0_24px_60px_-20px_rgba(0,0,0,0.5)]"
              >
