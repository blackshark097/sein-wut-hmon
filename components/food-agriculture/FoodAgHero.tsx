...
export function FoodAgHero() {
  ...
  return (
    <section
      aria-label="Food and Agriculture hero"
      className="relative flex w-full flex-col items-center justify-center overflow-hidden bg-bg"
      style={{ minHeight: "60vh" }}
    >
      <div aria-hidden="true" className="absolute inset-0">
        <Image
          src="/images/legacy/poultry-intro.jpg"
          alt="Poultry operations at a Sein Wut Hmon farm"
          fill
          sizes="100vw"
          priority
      ...
      <div
        className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-32 text-center sm:px-10 md:py-40"
      >
        <motion.span
          {...fadeUp(0.1)}
        ...
        >
          From genetics to feed to farm. An integrated protein production chain serving Myanmar.
        </motion.p>
      </div>
    </section>
  );
