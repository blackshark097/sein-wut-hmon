...
const MAP_URL = `https://www.google.com/maps?q=${encodeURIComponent(ADDRESS)}&output=embed`;
...
export function ContactMap() {
  ...
  const header = (
    <>
      <span className="text-subheading text-gold">Location</span>
      <h3 className="mt-4 text-heading text-text">
    ...
    >
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        ...
        <div className="mt-8 overflow-hidden rounded-lg border border-border/60 bg-bg-elev aspect-[16/9]">
          <iframe
            src={MAP_URL}
            title="Sein Wut Hmon Group office map"
            loading="lazy"
