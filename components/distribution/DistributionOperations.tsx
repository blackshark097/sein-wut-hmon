      ...
      <div className="mx-auto max-w-[1200px] px-6 md:px-10">
        ...
        >
          {OPS.map((op) => (
            <article
              key={op.num}
              className="swh-dist-card group relative flex min-h-[340px] flex-col overflow-hidden border border-border/70 bg-bg-elev px-6 pt-10 pb-9 transition duration-500 hover:-translate-y-1 hover:border-accent/55 hover:bg-[#131c2f] hover:shadow-[0_0_0_1px_rgba(0,173,238,0.25),0_30px_60px_-20px_rgba(0,173,238,0.18)] sm:px-8 md:min-h-[380px] md:px-10 md:pt-12 md:pb-11"
            >
              <div
                aria-hidden="true"
